...
export const portfolioConfig = {
  ...
  projects: [
      ...
      detail: {
        shortDescription: { en: 'Designed and validated a robust nonlinear control framework for a spherical semi-indoor airship for filming and monitoring applications. The system combines vector-thrust propulsion, buoyancy-assisted flight, and Sliding Mode-Based Backstepping Control to achieve stable trajectory tracking under disturbances.', zh: '设计并验证用于半室内飞艇 filming 和监控应用的鲁棒非线性控制框架。' },
